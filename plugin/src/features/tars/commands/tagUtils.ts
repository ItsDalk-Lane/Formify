...
export const fetchTagMeta = (app: App, editor: Editor, settings: TarsSettings): TagMeta => {
...
const getTagMeta = (app: App, editor: Editor, range: EditorRange, settings: TarsSettings): TagMeta => {
