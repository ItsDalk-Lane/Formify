...
export default {
	...
	'Provider not configured': 'Provider not configured. Please add it in Tars settings first.',
	...
	'Model test system prompt': 'You are verifying connectivity for the Obsidian FormFlow plugin.',
