...
export class En implements Local {
	...
	chat_settings_back_to_sub_agents = "Back to Sub Agents";
	chat_settings_save_failed = "Failed to save settings";
	tool_execution_max_tool_calls = "Shared Max Tool Calls";
	tool_execution_max_tool_calls_desc = "Use one shared limit for MCP loops and Tool Call Agent tool execution.";
	tool_execution_timeout = "Shared Tool Call Timeout (ms)";
	tool_execution_timeout_desc = "Use one shared timeout for Tool Call Agent requests and MCP execution fallback.";
	...
	sub_agents_tool_timeout_desc = "Abort the sub-agent request after this timeout";
	sub_agents_tool_allow_shell = "Allow Shell Commands";
	sub_agents_tool_allow_shell_desc = "If disabled, call_shell is blocked inside execute_task";
	sub_agents_tool_allow_script = "Allow Script Execution";
	sub_agents_tool_allow_script_desc = "If disabled, execute_script is blocked inside execute_task";
