...
export class ZhTw implements Local {
	...
	tool_execution_max_tool_calls_desc = "MCP 工具循環和 Tool Call Agent 的工具執行共用這一上限。";
	tool_execution_timeout = "共享工具呼叫逾時時間（毫秒）";
	tool_execution_timeout_desc = "Tool Call Agent 請求和 MCP 執行 fallback 共用這一逾時時間。";
	...
	sub_agents_tool_timeout_desc = "超過該時間後中止子代理請求";
	sub_agents_tool_allow_shell = "允許 shell 命令";
	sub_agents_tool_allow_shell_desc = "關閉後，execute_task 內將阻止 call_shell";
	sub_agents_tool_allow_script = "允許執行腳本";
	sub_agents_tool_allow_script_desc = "關閉後，execute_task 內將阻止 execute_script";
