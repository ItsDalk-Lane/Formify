...
/**
 * Unchecked（未选中）操作符处理器
 * 用于判断 CHECKBOX/TOGGLE 字段是否为未选中状态
 */
export class UncheckedOperatorHandler implements OperatorHandler {

    accept(filter: Filter) {
        return filter.operator === OperatorType.Unchecked;
    }
